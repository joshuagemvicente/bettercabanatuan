    ...
    <Section className="bg-gray-50">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600 mt-2 flex items-center justify-center gap-2 max-w-2xl mx-auto">
          ...
          <Link className='hover:underline text-primary-600' to="https://maps.google.com/maps?vet=10CAAQoqAOahcKEwjY-rLh1YSVAxUAAAAAHQAAAAAQFw..i&sca_esv=9773526fc95a52cb&pvq=CgwvZy8xaGMydGh6Y3I&fvr=1&cs=1&um=1&ie=UTF-8&fb=1&gl=ph&sa=X&ftid=0x339728f23e83546d:0xfa3d267b6c7aa1c1">
          {cityHallLocation.address}
          </Link>
        </p>
      </div>

      <div className="rounded-xl overflow-hidden border border-gray-200 shadow-sm [&_.leaflet-pane]:z-[1]">
        <MapContainer
          center={position}
